  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Store user info and call onRegister
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-border placeholder-muted-foreground text-foreground bg-background focus:outline-none focus:ring-ring focus:border-ring focus:z-10 sm:text-sm"
